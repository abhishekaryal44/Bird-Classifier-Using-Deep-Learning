    ...
    try:
        if request.method == 'POST':
            ...
            if submitted_image:
                ...
                new_image_path = f'classified_images/{current_datetime}_{submitted_image.name}'
                image_path = default_storage.save(new_image_path, submitted_image)
              ...
              # Generate the correct image URL using the 'url' template tag
                ...
                print(image_url)
                return redirect('species_detail_with_image_url', species_id=predicted_species.id, image_url=image_url)
...
def species_detail(request, species_id, image_url=None):
    ...
    context = {
        ...
        'image_url': image_url if image_url else (classified_image.image.url if classified_image else None),
